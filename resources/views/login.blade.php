 ...
 <html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
     <head>
         ...
         <style>
            ...
            .form .message {margin:15px 0 0;color:#a3a3a3;font-size:12px;}
            .form .message a {color:#3CAF50; text-decoration:none;}
    ...
    <body>
        <div class="login-page">
            ...
            <div class="form">
                <div class="detail">รายละเอียดของผู้ใช้งาน</div>
                <form class="register-form" method="POST" action="{{url('login/register')}}">
